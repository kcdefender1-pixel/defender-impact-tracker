...
const SEED_IMPACTS = [
  ...
  },
  {
    ...
    ai_narrative: "For Black women in Kansas City, the search for justice begins with having to be believed. The Defender's investigation into missing Black women exposes how stereotypes and delayed urgency from law enforcement and institutions determine who gets urgently searched for and who does not. The piece connects directly to the 2022 Jaynie Crosdale case, where KCPD dismissed Defender-amplified community reports of missing women as unfounded. Weeks later, TJ escaped her kidnapper's basement. The Defender told the truth then, and is still holding the record straight now.",
