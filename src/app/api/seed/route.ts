...
const SEED_IMPACTS = [
  ...
  },
  {
    ...
    program_area: 'editorial',
    impact_type: 'narrative_shift',
    raw_description: "The Defender's coverage of student organizing and resistance to ICE in schools reached over 2.5 million impressions across digital platforms. Coverage included student walkouts, youth-led organizing, and the fight against bills that would allow ICE agents into schools across the Kansas City metro area.",
    ai_narrative: "The Defender became the defining voice of student resistance to ICE in Kansas City. Our coverage of student walkouts, youth organizing, and the fight against bills that would allow ICE agents into schools reached over 2.5 million impressions across digital platforms. No other outlet in the region matched the breadth or depth of this coverage. The Defender's reporting amplified the organizing work of thousands of students, families, and coalition partners and put Kansas City student resistance on the national map.",
    internal_headline: 'Student Organizing Coverage Reaches 2.5 Million Impressions',
    funder_headline: 'Defender Coverage of Student Resistance to ICE Reaches 2.5 Million Digital Impressions',
